...
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   ...
   ICMP используется для передачи сообщений об ошибках и другой информации о состоянии сети, а не для передачи данных между 
...
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   ...
   - Различия объясняются разной целью: последние пакеты сообщают, что всё ок, а сообщения об ошибке несут доп информацию для идентификации ошибки. 
