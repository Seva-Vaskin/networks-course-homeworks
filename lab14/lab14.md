...
![](img/ws2.png)
   - 92:2c:09:16:15:64
   - Это должен быть MAC адрес моего телефона (я раздаю интернет через телефон). Однако, верифицировать я это не смог. 
...
Добавление продукта с токеном

![](img/add_prod_priv.png)

Добавление продукта без токена 
...
![](img/get_all_private.png)
![](img/get_all_public.png)
...
``` 
smtplib.SMTPDataError: (554, b'5.7.1 Message rejected under suspicion of SPAM; https://ya.cc/1IrBc 1717115093-pOGui41DZuQ0-WXjWvbFW')
```
